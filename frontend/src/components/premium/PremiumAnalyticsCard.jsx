    ...
    <div className="rounded-app border border-emeraldApp-100 bg-white p-5 shadow-card dark:bg-gray-900 dark:border-gray-700 dark:shadow-none flex flex-col gap-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-emeraldApp-900/60 dark:text-emeraldApp-100/60 text-[10px]">Receitas</span>
          </div>
          <div className="flex items-center gap-1.5">
            <div className="w-2 h-2 rounded-full" style={{ backgroundColor: line2Color }} />
            <span className="text-emeraldApp-900/60 dark:text-emeraldApp-100/60 text-[10px]">Despesas</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative" style={{ height: 220 }}>
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-between px-1">
          {line1Data.map((d, i) => (
            <span key={i} className="text-[9px] text-emeraldApp-900/50 dark:text-emeraldApp-100/50">{d.label}</span>
          ))}
        </div>
      </div>
    </div>
